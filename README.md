# currencycalculatorspringreactpostgre
...
```
git clone https://gitflic.ru/project/gagarin1love/currencycalculatorspringreactpostgre.git
cd currencycalculatorspringreactpostgre
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/gagarin1love/currencycalculatorspringreactpostgre.git
git clone
